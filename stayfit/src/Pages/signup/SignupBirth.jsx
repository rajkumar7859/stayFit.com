	...
	return (
		<>
            ...
            Please select which sex we should use to calculate your calorie needs.
						...
						<>
						<Button color='blue' fontWeight={'400'} onClick={onOpen}>
      ...
      >
        <AlertDialogOverlay>
          <AlertDialogContent>
            ...
            <AlertDialogFooter>
              <Button ref={cancelRef} color='blue' onClick={()=>window.location.href='https://support.myfitnesspal.com/hc/en-us/articles/360059617352'}>
                LEARN MORE
              </Button>
            </AlertDialogFooter>
          </AlertDialogContent>
					...
					<Box className="tallSubBox" w='100%'>
						...
						When were you born?
							...
							<Input w="200px" type ='date' color='grey' />
					</Box>
					...
					<Box className="tallSubBox" w='100%'>
						...
						<select  style={{width:"100px",height:'30px',color:'grey'}}>
...
<option value="Zimbabwe">Zimbabwe</option>
					...
					<Flex gap="20px">
						...
						<Button bg="#0066EE" color="white" w="150px" fontSize="18px" onClick={() => navigate("/signupTall")}>
							NEXT
						</Button>
					</Flex>
				</Box>
